...
using static HeavyItemSCPs.SCP.SCP178.SCP1781AI;

namespace HeavyItemSCPs.SCP.SCP178
{
    public class SCP178Behavior : PhysicsProp, ISingletonItem, ISCP
    {
        public GameObject SCP1781Prefab = null!;
        ...
        public void SpawnEntities()
        {
            ...
            IEnumerator SpawnEntitiesCoroutine()
            {
                try
                {
                    ...
                    if (SCP1781AI.Instances.Count == 0)
                    {
                        int maxCount = (int)minMaxCount.GetRandomInRange(Utils.randomLocal);
                        int count = 0;
                        ...
                        logger.LogDebug($"Spawned {SCP1781AI.Instances.Count} SCP-178-1 instances");
                    }
                }
                finally
                {
    ...
    public class SCP178Patches
    {
        ...
        {
            if (HeavyItemSCPsContentHandler.Instance.SCP178 != null)
            {
        ...
        {
            if (HeavyItemSCPsContentHandler.Instance.SCP178 != null && SCP178Behavior.Instance != null)
            {
