...
namespace HeavyItemSCPs
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            configTransformOpenMultiplier = Config.Bind("SCP-427", "Transform open multiplier", 10f, "The multiplier applied to the time it takes to transform when the necklace is opened. configTimeToTransform will be multiplied by this value.");
            ...
            configContinueSpawningAfterPickup = Config.Bind("SCP-427", "Continue spawning after picked up", true, "Whether or not SCP-427 should continue spawning SCP-427-1 instances after being picked up by a player or lootbug. Setting this to true will make SCP-427 keep spawning SCP-427-1 instances if its on the ground, regardless of whether its been picked up or not."); // TODO: Set to true for testing, change back later
