...
namespace HeavyItemSCPs
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        const string PLUGIN_VERSION = "1.3.2";
        ...
        private void Awake()
        {
            ...
            config4271DropMethod = Config.Bind("SCP-427-1", "Drop method", DropMethod.DropAllItems, "When the player is grabbed by SCP-427-1, they should drop: 0 = Drop nothing, 1 = Drop held item, 2 = Drop two-handed item, 3 = Drop all items.");
